/**
 * @file
 * Implements FFT PhaseClock ColorWave strategy.
 */
...
// Includes strategy.
#include "Stg_FFT_PhaseClock_ColorWave.mqh"
...
// Defines.
#define ea_name "Strategy FFT PhaseClock ColorWave"
#define ea_version "1.000"
#define ea_desc "Strategy based on EA31337 framework with FFT PhaseClock ColorWave signals."
