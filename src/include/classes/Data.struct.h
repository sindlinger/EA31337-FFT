...
struct DataParamEntry : public MqlParam {
 public:
  ...
  DataParamEntry(const bool _value) { operator=(_value); }
  DataParamEntry(const datetime _value) { operator=(_value); }
  DataParamEntry(const double _value) { operator=(_value); }
  DataParamEntry(const int _value) { operator=(_value); }
  DataParamEntry(const long _value) { type = TYPE_LONG; integer_value = _value; }
  DataParamEntry(const string _value) { operator=(_value); }
  DataParamEntry(const unsigned int _value) { operator=(_value); }
  DataParamEntry(const unsigned long _value) { type = TYPE_ULONG; integer_value = (long)_value; }
