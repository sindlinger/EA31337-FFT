...
struct IndicatorDataEntryValue {
  ...
  IndicatorDataEntryValue() { flags = 0; value.vlong = 0; }
  IndicatorDataEntryValue(const double _value) { flags = 0; Set(_value); }
  IndicatorDataEntryValue(const float _value) { flags = 0; Set(_value); }
  IndicatorDataEntryValue(const int _value) { flags = 0; Set(_value); }
  IndicatorDataEntryValue(const long _value) { flags = 0; Set(_value); }
